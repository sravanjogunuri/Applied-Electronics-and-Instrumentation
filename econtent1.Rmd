...
fontsize: 8pt
geometry: "left=2cm,right=2cm,top=0.25cm,bottom=0.25cm"
output: pdf_document
---
...
+ ***[$\text{\underline{\color{blue}Click here}}$](https://ecourses.icar.gov.in/) to access e-krishi Shiksha portal of ICAR***.
+ ***[$\text{\underline{\color{blue}Click here}}$](https://krishikosh.egranth.ac.in) to access institutional thesis repository of ICAR***.
+ ***[$\text{\underline{\color{blue}Click here}}$](https://icar.org.in/e-books) to access collection of e-books published by ICAR***.
+ ***[$\text{\underline{\color{blue}Click here}}$](http://epubs.icar.org.in/ejournal/) to access different e-journals published by ICAR***.
+ ***[$\text{\underline{\color{blue}Click here}}$](https://ocw.mit.edu/) to access MIT open courseware(OCW)***.

***Note: At any stage, if the learner, is unable to grasp things, he is free to learn the same from any other resource mentioned below other than list of MOOCs or recommended to reach the faculty concerned for further help.***
